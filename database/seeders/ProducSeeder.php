    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                'name'=>'Oppo mobile',
                "price"=>"300",
                "details"=>"A smartphone with 8gb ram and much more feature",
                "category"=>"mobile",
            ...
            [
                'name'=>'Panasonic Tv',
                "price"=>"400",
                "details"=>"A smart tv with much more feature",
                "category"=>"tv",
            ...
            [
                'name'=>'Soni Tv',
                "price"=>"500",
                "details"=>"A tv with much more feature",
                "category"=>"tv",
            ...
            [
                'name'=>'LG fridge',
                "price"=>"200",
                "details"=>"A fridge with much more feature",
                "category"=>"fridge",
